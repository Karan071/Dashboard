...
import { CalendarDays, CheckCircle2, XCircle, Clock, PlayCircle, HelpCircle, IndianRupee, Video, Tablet } from "lucide-react";
...
import { Bell, Download, Eye, Flag, MessageSquare, X, ChevronLeft, ChevronRight } from "lucide-react";
...
function SessionTables() {
    ...
    const currentRecords = UpcomingSessionsTable.slice(indexOfFirstRecord, indexOfLastRecord)
            ...
            <div className="rounded-md border bg-white p-5">
                        ...
                        <TableBody>
                            {currentRecords.map((user) => (
                                <TableRow key={user.id}>
                                    ...
                                    <TableCell>
                                        <div className="text-sm">{user.statusTimeline[0]}</div>
                                        <div className="text-sm">{user.statusTimeline[1]}</div>
                                        <div className="text-sm">{user.statusTimeline[2]}</div>
                                    </TableCell>
                ...
                <div className="flex items-center justify-between border-t p-4">
                    <div className="text-sm text-gray-500">
                        Showing {indexOfFirstRecord + 1}-{Math.min(indexOfLastRecord, UpcomingSessionsTable.length)} of {UpcomingSessionsTable.length} explorers
                    </div>
                    <div className="flex items-center gap-2">
                        <Button
                            variant="outline"
